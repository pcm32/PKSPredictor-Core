...
class QueryRunner(object):
    ...
    def runQuery(self):
        ...
        if self.fuzzProPath:
            ...
            sequenceMarkers.append(PatternFeatureMarker(self.fuzzProPath, "[LA]HP[SCAG][LMVI][LMVI]D[SAG][AG]", "DH_conf"))
            sequenceMarkers.append(PatternFeatureMarker(self.fuzzProPath, "[LA]HP[SCAG][LMVI][LMVI][SAG][AG]", "PS_not_DH"))
